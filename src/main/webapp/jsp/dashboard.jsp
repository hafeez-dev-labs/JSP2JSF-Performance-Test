...
<!DOCTYPE html><html><head><title>JSP Dashboard</title><link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/dashboard.css"></head><body><main>
